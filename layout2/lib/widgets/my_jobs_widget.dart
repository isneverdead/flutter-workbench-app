                                  ...
                                  child: FlatButton(
                                    ...
                                    onPressed: () {
                                      screenState.changedetailTeamListContent(
                                          'pending');
                                      job.fillFilteredJobsByStatus('2');
                                ...
                                child: Tooltip(
                                  ...
                                  child: FlatButton(
                                    ...
                                    onPressed: () {
                                      screenState.changedetailTeamListContent(
                                          'canceled');
                                      job.fillFilteredJobsByStatus('4');
                                      screenState.changedetailTeamMembers(
                                          'hide members');
                                    },
                                    shape: RoundedRectangleBorder(
                                ...
                                child: Tooltip(
                                  ...
                                  child: FlatButton(
                                    ...
                                    onPressed: () {
                                      screenState.changedetailTeamListContent(
                                          'completed');
                                      job.fillFilteredJobsByStatus('1');
                                      screenState.changedetailTeamMembers(
                                          'hide members');
                                    },
                                    shape: RoundedRectangleBorder(
                                ...
                                child: Tooltip(
                                  ...
                                  child: FlatButton(
                                    ...
                                    onPressed: () {
                                      screenState.changedetailTeamListContent(
                                          'progres');
                                      job.fillFilteredJobsByStatus('3');
                                      screenState.changedetailTeamMembers(
                                          'hide members');
                                    },
                                    shape: RoundedRectangleBorder(
                      ...
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              '${job.jobs.length} tugas sedang dikerjakan',
                              style: TextStyle(
                                  fontSize: _4highDevice * 0.09,
                                  fontWeight: FontWeight.w600,
                                  color: Colors.white),
