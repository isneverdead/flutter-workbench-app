...
import 'package:layout2/widgets/team_lists_admin_widget.dart';
...
class _HomeWidgetAdminState extends State<HomeWidgetAdmin> {
  ...
  void _changeHomePageView(String view) {
    ...
    //   screenState.changeListContent(view);
    // } catch (e) {
    //   throw e;
    // }
    // widget.view = view;
                              ...
                              child: Column(
                                ...
                                children: [
                                  Container(
                                    ...
                                    child: Text(
                                      'Hi,  ${auth.username != null ? auth.username : 'Admin'}',
                                      style: TextStyle(
...
// you have 5 task
          ...
          if (_homePageView == 'team') TeamListsAdmin(),
        ],
      ),
    );
  }
