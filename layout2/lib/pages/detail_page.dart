                    ...
                    children: [
                      Column(
                        ...
                        children: [
                          ...
                          Container(
                            margin: EdgeInsets.only(top: _4highDevice * 0.25),
                                    ...
                                    onPressed: () async {
                                      ...
                                      await job.updateJob(
                                          ...
                                          Job(
                                              ...
                                              status: job.loadedPostById.values
                                                  .toList()[0]
                                                  .status,
...
// name card
                          ...
                          Container(
                            ...
                            child: TextField(
                              ...
                              // onChanged: (value) {
                              //   job.findById(
                              //       job.loadedPostById.values.toList()[0].id);
                              // },
                              minLines: 5,
                              maxLines: 5,
                              decoration: InputDecoration(
                      ...
                      Container(
                        margin: EdgeInsets.only(bottom: _4highDevice * 0.2),
                        child: Row(
                              ...
                              child: IconButton(
                                ...
                                onPressed: () {
                                  ...
                                  if (_stage == _deleteStage.stage3) {
                                    job.deleteJob(job.loadedPostById.values
                                        .toList()[0]
                                        .id);
                                  }
                                },
                                  ...
                                  job.updateJob(
                                      ...
                                      Job(
                                        id: job.loadedPostById.values
                                            .toList()[0]
                                            .id,
                                        title: job.loadedPostById.values
                                            .toList()[0]
                                            .title,
                                        status: '1',
                                        kendala: job.loadedPostById.values
                                            .toList()[0]
                                            .kendala,
                                        tanggal: '',
                                      ));
